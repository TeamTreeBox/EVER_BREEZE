...
Current version
- Added "Use Fast Mask Shader" option to Global Snow Ignore Coverage script and also Global Snow inspector (as global setting)
- Added "Exclusion Default CutOff" option to deferred rendering
- [Fix] Fixed Ignore Coverage script state issue related with application domain reload improvements
